...
(function (global, factory) {
  ...
  var Treeview = function ($) {
    ...
    var Selector = {
      LI: '.nav.blade.php-item',
      LINK: '.nav.blade.php-link',
      TREEVIEW_MENU: '.nav.blade.php-treeview',
      OPEN: '.menu-open',
  ...
  var Dropdown = function ($) {
    ...
    function () {
      ...
      _proto.toggleSubmenu = function toggleSubmenu() {
        ...
        this._element.parents('li.nav.blade.php-item.dropdown.show').on('hidden.bs.dropdown', function (e) {
