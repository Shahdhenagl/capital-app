...
(function (global, factory) {
    ...
    const SELECTOR_NAV_ITEM = '.nav.blade.php-item';
    const SELECTOR_NAV_LINK = '.nav.blade.php-link';
    const SELECTOR_TREEVIEW_MENU = '.nav.blade.php-treeview';
    ...
    class AccessibilityManager {
        ...
        ensureSkipTargets() {
            ...
            const nav = document.querySelector('#navigation, nav.blade.php, [role="navigation"]');
            if (nav && !nav.id) {
                nav.id = 'navigation';
            }
        ...
        initKeyboardNavigation() {
            document.addEventListener('keydown', (event) => {
                const target = event.target;
                if (target.closest('.nav.blade.php, .navbar-nav.blade.php, .dropdown-menu')) {
        ...
        handleMenuNavigation(event) {
            ...
            const menuItems = Array.from(currentElement.closest('.nav.blade.php, .navbar-nav.blade.php, .dropdown-menu')?.querySelectorAll('a, button') || []);
      ...
      `;
        ...
        addLandmarks() {
            ...
            document.querySelectorAll('.navbar-nav.blade.php, .nav.blade.php').forEach((nav, index) => {
